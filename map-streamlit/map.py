...
def map_search():
    ...
    if location :
        st.session_state["locality"] = location["locality"]
        st.session_state["address"] = location["address"]
        st.session_state["latitude"] = location["latitude"]
        st.session_state["longitude"] = location["longitude"]
        st.session_state["infos"] = location["infos"]
...
if "address" in st.session_state :
    ...
    st.sidebar.text(f"Ville : {st.session_state['locality']}")
    ...
    if "nearby_places" in st.session_state :
        for city_item in st.session_state["nearby_places"]:
            if st.session_state["locality"] != city_item["locality"]:
                folium.Marker(
